	...
	if ($('#loginForm').form('validate')) {
	    $('#loginForm').form('submit', {
	        ...
	        success:function(data){
	        	...
	        	if(item.code == 0){
	        		SetPwdAndChk();
	        		window.location.href =baseurl+"/customer/product/productInfo.do";
	        		$("#login-alert").html("");
	        		$("#login-alert").hide();
	        	}
	        	else{
                ...
                <div class="fl panel">
                    ...
                    <p class="login-rows mt30">
                    	<label class="yw-checkbox">
	                    	<i class="mt4 mr10"  onClick="loginCheck(this);" id="icheckspan"></i>
	                    	<input type="checkbox" name="rememberMe" value="false" id="chkRememberPwd">记住密码
	                    </label>
                        <span class="fr font-size12 mr20">
                        	<a href="#">忘记密码</a>
                        </span>
                    </p>
                    ...
                    <p class="login-rows mt10">
                        ...
                        <span class="fr font-size12 mt20">
                        	没有账号？<a href="javaScript:void(0);" onclick="register();">立即注册</a>
                        </span>
                    </p>
                </div>
            </div>
