package com.utron.yw.common.utils;
...
public class MD5Util {
	/*
	 * 涓嬮潰杩欎簺S11-S44瀹為檯涓婃槸涓?釜44鐨勭煩闃碉紝鍦ㄥ師濮嬬殑C瀹炵幇涓槸鐢?define 瀹炵幇鐨勶紝 杩欓噷鎶婂畠浠疄鐜版垚涓簊tatic
	 ...
	 * 銆?洜涓簀ava涓殑byte鐨則oString鏃犳硶瀹炵幇杩欎竴鐐癸紝鎴戜滑鍙堟病鏈塁璇█涓殑 sprintf(outbuf,"%02X",ib)
	 */
